...
jclass load_dll_bootstrap(JNIEnv* env, jobject game_loader,
    ...
    // bridge's job is to re-define every class in dannyhack.jar onto the game
    ...
    //
    // The build renames every dannyhack class to an opaque generated name (see
