 ...
 * (parent = Forge GameClassLoader) and re-defines every class in dannyhack.jar onto
 ...
 *       via the {@code dannyhack.resources} system property so
...
public final class GameLoaderBridge {
    ...
    public static final String RESOURCES_PROP = "dannyhack.resources";
    ...
    public static void load(String jarPath, ClassLoader gameLoader) throws Throwable {
        ...
        Path resourceDir = Paths.get(System.getProperty("java.io.tmpdir"),
                "dannyhack-resources-" + ProcessHandle.current().pid());
