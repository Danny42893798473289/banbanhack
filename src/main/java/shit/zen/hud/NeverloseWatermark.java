...
public class NeverloseWatermark {
    ...
    public void onRender2D(Render2DEvent render2DEvent) {
        ...
        float brandWidth = this.measureText("dannyhack", this.boldFont);
        currentX += brandWidth + gap;
    ...
    public void onGlRender(GlRenderEvent glRenderEvent) {
        ...
        float gap = 6.0f;
        float cornerRadius = 4.5f;
        currentX = this.renderSection(glRenderEvent.drawContext(), currentX, y, "dannyhack", this.boldFont, cornerRadius, gap);
    ...
    private float getTotalWidth() {
        float total = 0.0f;
        float gap = 6.0f;
        total += this.measureText("dannyhack", this.boldFont) + gap;
